...
<body>
	...
	<form name="catalogDownloadForm" method="post"
		...
		<span class="label">Filter products by short description:
			...
			<optgroup label="select file type">
				<option><%=Constants.PARAM_FILE_TYPE_VALUE_XML%></option>
				<option><%=Constants.PARAM_FILE_TYPE_VALUE_XHTML%></option>
			</optgroup>
		</select> <br /> 
